...
CREATE TABLE `service_requests` (
  ...
  `contract_work_order_number` varchar(255) DEFAULT NULL,
  ...
  `hosted_id` varchar(255) DEFAULT NULL,
  `ibm_log_on_id` varchar(255) DEFAULT NULL,
  ...
  `lso_group_code` varchar(255) DEFAULT NULL,
  ...
  `tso_group_code` varchar(255) DEFAULT NULL,
  `unix_access_group` varchar(255) DEFAULT NULL,
  `unix_account_number` varchar(255) DEFAULT NULL,
  ...
  `unix_log_on_id` varchar(255) DEFAULT NULL,
...
INSERT INTO `service_requests` (`request_number`, `adaptive_authentication_vpn`, `add_logon_id`, `billing_account_number`, `bin_number`, `business_city`, `business_justification`, `business_phone_number`, `business_state`, `business_street_address`, `business_zip`, `change_logon_id`, `cherwell_sms`, `company_city`, `company_email_address`, `company_name`, `company_phone_number`, `company_state`, `company_street_address`, `company_zip`, `contract_expiration_date`, `contract_work_order_number`, `county_email_address`, `county_phone_number`, `create_date`, `default_county_wide_policy`, `delete_logon_id`, `delete_prior_registration`, `department_name`, `department_number`, `department_policy_rule0`, `department_policy_rule1`, `department_policy_rule2`, `department_policy_rule3`, `department_policy_rule4`, `email_encryption`, `employee_email_address`, `employee_number`, `exchange_email`, `first_name`, `gmail_access`, `group_name`, `hosted_id`, `ibm_log_on_id`, `internet_application`, `is_complete`, `is_employee`, `la_county_gov_access`, `lac_mobile_wifi_access`, `last_name`, `lso_group_code`, `major_group_code`, `middle_initial`, `new_registration`, `old_group`, `online_access`, `other_email_access`, `other_email_domain`, `replace_lost_token`, `request_status`, `secur_id_vpn`, `security_authorization`, `social_networking_facebook`, `social_networking_linked_in`, `social_networking_twitter`, `sub_group1`, `sub_group2`, `sub_group3`, `submit_date`, `system_application`, `tokenless_authentication`, `tso_access`, `tso_group_code`, `unix_access_group`, `unix_account_number`, `unix_add_logon_id`, `unix_application`, `unix_change_logon_id`, `unix_delete_logon_id`, `unix_log_on_id`, `update_prior_registration`, `windows_rights_mgmt`, `work_mailing_address`, `yahoo_mail_access`, `access_type`, `aps_ao`, `customer_signature`, `customer_signature_date`, `department_email_address`, `dmv_system_code`, `jai_system_location`, `registration_type`, `request_type`, `unix_request_type`, `work_phone_number`, `agreement_id`) VALUES
(485729,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'844362',	'Bin Number',	'Los Angeles',	'Access required to these technologies.',	'555-263-8342',	'CA',	'500 Example Ave.',	'90032',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Los Angeles',	'jgarc659@calstatela.edu',	'Jim\'s Burgers',	'232-626-1673',	'CA',	'123 Apple St.',	'90032',	'06/01/2021',	'C2672721',	'example@lacounty.gov',	'612-626-7832',	'03/07/2021',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Example Department',	'512',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'jgarc659@calstatela.edu',	'15',	CONV('0', 2, 10) + 0,	'John',	CONV('1', 2, 10) + 0,	'Test Group',	'265',	'23626',	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Doe',	'2352762',	'272727',	'F',	CONV('1', 2, 10) + 0,	'Old Group',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	'Submitted',	CONV('0', 2, 10) + 0,	'Authorization',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Test Subgroup',	'Test Subgroup',	'Test Subgroup',	'03/18/2021',	'',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Group Code',	'',	'',	CONV('1', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'261361',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'100 3rd St, Los Angeles, CA, 90032',	CONV('0', 2, 10) + 0,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'CBJCHBCAABAAG0LtJ984UbGtuj1HnIRiZanFzBAGJmn3'),
(572008,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'844362',	'Bin Number',	'Los Angeles',	'Access required to these technologies.',	'555-263-8342',	'CA',	'500 Example Ave.',	'90032',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Los Angeles',	'jgarc659@calstatela.edu',	'Jim\'s Burgers',	'232-626-1673',	'CA',	'123 Apple St.',	'90032',	'06/01/2021',	'C2672721',	'example@lacounty.gov',	'612-626-7832',	'03/07/2021',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Example Department',	'512',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	'15',	CONV('0', 2, 10) + 0,	'John',	CONV('1', 2, 10) + 0,	'Test Group',	'265',	'23626',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Doe',	'2352762',	'272727',	'F',	CONV('1', 2, 10) + 0,	'Old Group',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	'Draft',	CONV('0', 2, 10) + 0,	'Authorization',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Test Subgroup',	'Test Subgroup',	'Test Subgroup',	'',	'',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Group Code',	'',	'',	CONV('1', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'261361',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'100 3rd St, Los Angeles, CA, 90032',	CONV('0', 2, 10) + 0,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(801594,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'844362',	'Bin Number',	'Los Angeles',	'Access required to these technologies.',	'555-263-8342',	'CA',	'500 Example Ave.',	'90032',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Los Angeles',	'jgarc659@calstatela.edu',	'Jim\'s Burgers',	'232-626-1673',	'CA',	'123 Apple St.',	'90032',	'06/01/2021',	'C2672721',	'example@lacounty.gov',	'612-626-7832',	'03/07/2021',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Example Department',	'512',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'employee@publicdefender.gov',	'15',	CONV('0', 2, 10) + 0,	'John',	CONV('1', 2, 10) + 0,	'Test Group',	'265',	'23626',	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Doe',	'2352762',	'272727',	'F',	CONV('1', 2, 10) + 0,	'Old Group',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	'Submitted',	CONV('0', 2, 10) + 0,	'Authorization',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Test Subgroup',	'Test Subgroup',	'Test Subgroup',	'03/08/2021',	'System Application',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Group Code',	'Unix Access Group',	'Unix Account Number',	CONV('1', 2, 10) + 0,	'Unix Application',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'261361',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'100 3rd St, Los Angeles, CA, 90032',	CONV('0', 2, 10) + 0,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(804943,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'844362',	'Bin Number',	'Los Angeles',	'Access required to these technologies.',	'555-263-8342',	'CA',	'500 Example Ave.',	'90032',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Los Angeles',	'jgarc659@calstatela.edu',	'Jim\'s Burgers',	'232-626-1673',	'CA',	'123 Apple St.',	'90032',	'06/01/2021',	'C2672721',	'example@lacounty.gov',	'612-626-7832',	'03/07/2021',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Example Department',	'512',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	'15',	CONV('0', 2, 10) + 0,	'John',	CONV('1', 2, 10) + 0,	'Test Group',	'265',	'23626',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Doe',	'2352762',	'272727',	'F',	CONV('1', 2, 10) + 0,	'Old Group',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'',	CONV('0', 2, 10) + 0,	'Draft',	CONV('0', 2, 10) + 0,	'Authorization',	CONV('1', 2, 10) + 0,	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'Test Subgroup',	'Test Subgroup',	'Test Subgroup',	'',	'System Application',	CONV('0', 2, 10) + 0,	CONV('1', 2, 10) + 0,	'Group Code',	'Unix Access Group',	'Unix Account Number',	CONV('1', 2, 10) + 0,	'Unix Application',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'261361',	CONV('0', 2, 10) + 0,	CONV('0', 2, 10) + 0,	'100 3rd St, Los Angeles, CA, 90032',	CONV('0', 2, 10) + 0,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);
